$(document).ready(function(){
	...
	$("#menu li").on("click",function(e){
		...
		//브라우저의 높이 값 + 박스의 순서 값은 현재 박스의 스크롤 위치 값과 동일
		var nowTop = i*ht;
